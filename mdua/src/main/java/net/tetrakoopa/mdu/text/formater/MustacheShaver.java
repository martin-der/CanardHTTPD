package net.tetrakoopa.mdua.text.formater;
...
public class MustacheShaver<CONTEXT> {
...
//	private final static char EVAL = '#';
//
//	public interface BarberTools<CONTEXT> {
//
//		void shave(CONTEXT context, Object spray, Writer outputStream, int extraMustaches) throws IOException;
//
